                                ...
                                <td>
                                    ...
                                    @elseif($pedido->status == 'Pronto')
                                        <form action="{{ route('pedidos.updateStatus', $pedido->id) }}" method="POST" class="d-inline">
                                            ...
                                            <button type="submit" class="btn btn-sm" style="background-color: #98C9A3">Marcar como
                                                Concluído</button>
                                        </form>
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ route('pedidos.nota-fiscal', $pedido->id) }}" class="btn btn-success btn-sm">Gerar
                                        Nota Fiscal</a>
                                </td>
                            </tr>
                        @endforeach
